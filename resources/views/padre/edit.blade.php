...
@section('content')
    ...
    <form action="{{route('padre-update', ['id'=>$model->id])}}" method="post">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="data" placeholder="Ex: {{date('d/m/Y',strtotime('now'))}}" id="data" value="{{$model->data}}" class="form-control" required>
            </div>
        </div>
